...
class _DificultGamePageState extends State<DificultGamePage>
  ...
  Future<void> _playNoteSound(String noteName) async {
    try {
      ...
      // Nota: En nivel difícil, solo reproducir sonidos basados en notas reales de la base de datos
      print('🎵 Note sound requested: $noteName (disabled in difficult mode)');
    } catch (e) {
